...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice teamwork, skills, and competitive soccer",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Build basketball fundamentals and play in friendly matches",
    ...
    "Drama Club": {
        "description": "Act in plays, improve performance skills, and stage scenes",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "logan@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design robots, solve problems, and compete in challenges",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["amelia@mergington.edu", "elijah@mergington.edu"]
    },
    "Science Bowl": {
        "description": "Prepare for academic competitions in science and math",
